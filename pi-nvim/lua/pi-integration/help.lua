...
function M.toggle(ctx)
	...
	vim.list_extend(lines, {
		...
		"- Bash approval: Allow once, Remember, or Deny. Closing the picker denies.",
		"- Remember opens an optional note float, then asks Allow once/Deny for the same call.",
		"- Close the note float to save without a note.",
