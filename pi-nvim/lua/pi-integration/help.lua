...
function M.toggle(ctx)
	...
	vim.list_extend(lines, {
		...
		"- `ask`: allow read-only operations and ask before access-gated bash, edit, or write tools.",
		"- `readonly`: allow read-only operations and block access-gated mutations without asking.",
		"",
		"## Integration Modes",
		"",
