...
function M.toggle(ctx)
	...
	vim.list_extend(lines, {
		...
		"- Bash approval: Allow once, Remember (without running), or Deny. Closing the picker denies.",
		"- Remember opens an optional note float; close it to save without a note.",
		"- `/pi-bash-review` reviews saved commands and can trust an exact command in its directory.",
		"",
		"## Integration Modes",
		"",
