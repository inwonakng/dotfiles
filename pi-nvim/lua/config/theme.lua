...
require("catppuccin").setup({
	...
	custom_highlights = function(colors)
		return {
			...
			PiUsageInput = { fg = colors.blue, bg = M.ui_bg },
			PiUsageOutput = { fg = colors.red, bg = M.ui_bg },
			PiUsageContext = { fg = colors.overlay1, bg = M.ui_bg },
			PiUsageCost = { fg = colors.green, bg = M.ui_bg },
			...
			PiIntegrationAsk = { fg = colors.yellow, bg = M.ui_bg, bold = true },
			PiIntegrationAllowed = { fg = colors.green, bg = M.ui_bg, bold = true },
			PiIntegrationDenied = { fg = colors.overlay0, bg = M.ui_bg },
