--- source code from https://github.com/dmgerman/hs_select_window.spoon/blob/main/init.lua
---
--- dmg hammerspoon
---
...
function obj:print_windows()
	function w_info(w)
		return string.format("[%s] [%s] [%s]", w:application():bundleID(), w:application():name(), w:title())
	end
