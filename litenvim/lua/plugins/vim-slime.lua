...
vim.keymap.set("n", "<leader>rc", "<CMD>SlimeConfig<CR>", { desc = "Slime Config" })
vim.keymap.set("n", "<leader>rp", "<CMD>SlimePickPane<CR>", { desc = "Pick Tmux Pane" })
vim.keymap.set("n", "<leader>rr", "<Plug>SlimeSendCell", { desc = "Slime Send Cell" })
vim.keymap.set("v", "<leader>rr", ":<C-u>'<,'>SlimeSend<CR>", { desc = "Slime Send Selection" })
vim.keymap.set("n", "<leader>rn", "o# %%<ESC>o<ESC>D", { desc = "Slime Insert New Cell" })
vim.keymap.set("n", "]r", "/# %%<CR>", { desc = "Slime Next Cell" })
vim.keymap.set("n", "[r", "k/# %%<CR>N", { desc = "Slime Previous Cell" })
vim.keymap.set("n", "<leader>rf", function()
	_G.SlimeFolds.create_slime_cell_folds()
end, { desc = "Create folds for slime cells (open)" })
vim.keymap.set("n", "<leader>rF", function()
	_G.SlimeFolds.create_and_close_slime_cell_folds()
end, { desc = "Create folds for slime cells (closed)" })
